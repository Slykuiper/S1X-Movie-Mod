...
Download [this mod](https://github.com/Slykuiper/S1X-Movie-Mod/releases) (latest .zip) and put the **slymvm** folder in `\[rootfolder]\S1x\lua-scripts\`. Create the lua-scripts folder if it's missing.
