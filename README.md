...
Huge shoutout to Snake & the XLabs Team as well as xensik <3
...
Download [this mod](https://github.com/Slykuiper/S1X-Movie-Mod/archive/refs/heads/main.zip) and put the **slymvm** folder in `\[rootfolder]\S1x\lua-scripts\`. Create the lua-scripts folder if it's missing.
